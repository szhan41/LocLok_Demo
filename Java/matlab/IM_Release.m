function [z, z_true, var_z, A, vertices, time_elps] = IM_Release(true_loc, state_no, eps, DeltaX, T, mx_size)
...
[n1 var_z]=IMNoise(A,d,eps,vertices);
z=z_true+n1;
time_elps=toc;
...
function [Trans vertices]=Find_Transf(DeltaX,T)
% find the minimum enclosing ellipsoid;
    ...
    samples=test_sample(vertice,sample_size);
...
function [n1 var1]=IMNoise(Trans,d,epsi,vertice)
